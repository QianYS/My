...
@Injectable()
export class LoginAttemptServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    getIndex(filter: string | null | undefined, skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<PagedResultDtoOfLoginAttemptShowIndexDto> {
        let url_ = this.baseUrl + "/api/services/app/LoginAttempt/GetIndex?";
        if (filter !== undefined)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfLoginAttemptShowIndexDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfLoginAttemptShowIndexDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetIndex(response: HttpResponseBase): Observable<PagedResultDtoOfLoginAttemptShowIndexDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfLoginAttemptShowIndexDto.fromJS(resultData200) : new PagedResultDtoOfLoginAttemptShowIndexDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfLoginAttemptShowIndexDto>(<any>null);
    }
}
...
export class OrganizationUnitServiceProxy {
    ...
    getAllTree(): Observable<OrganizationUnitTreeDto[]> {
        let url_ = this.baseUrl + "/api/services/app/OrganizationUnit/GetAllTree";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllTree(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllTree(<any>response_);
                } catch (e) {
                    return <Observable<OrganizationUnitTreeDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<OrganizationUnitTreeDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processGetAllTree(response: HttpResponseBase): Observable<OrganizationUnitTreeDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (resultData200 && resultData200.constructor === Array) {
                result200 = [];
                for (let item of resultData200)
                    result200.push(OrganizationUnitTreeDto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<OrganizationUnitTreeDto[]>(<any>null);
    }
...
export class RoleServiceProxy {
     ...
     * @return Success
     */
    getAllPermissionsTree(): Observable<ListResultDtoOfPermissionDto> {
    ...
    protected processGetAllPermissionsTree(response: HttpResponseBase): Observable<ListResultDtoOfPermissionDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getRolesIndexList(filter: string | null | undefined, skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<PagedResultDtoOfRoleDto> {
        let url_ = this.baseUrl + "/api/services/app/Role/GetRolesIndexList?";
        if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&"; 
        if (skipCount !== undefined)
            url_ += "SkipCount=" + encodeURIComponent("" + skipCount) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetRolesIndexList(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetRolesIndexList(<any>response_);
                } catch (e) {
    ...
    protected processGetRolesIndexList(response: HttpResponseBase): Observable<PagedResultDtoOfRoleDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class UserServiceProxy {
     ...
     * @return Success
     */
    getUsersIndexList(filter: string | null | undefined, skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<PagedResultDtoOfUserListDto> {
        let url_ = this.baseUrl + "/api/services/app/User/GetUsersIndexList?";
        if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&"; 
        if (skipCount !== undefined)
            url_ += "SkipCount=" + encodeURIComponent("" + skipCount) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetUsersIndexList(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetUsersIndexList(<any>response_);
                } catch (e) {
    ...
    protected processGetUsersIndexList(response: HttpResponseBase): Observable<PagedResultDtoOfUserListDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class PagedResultDtoOfLoginAttemptShowIndexDto implements IPagedResultDtoOfLoginAttemptShowIndexDto {
    totalCount: number | undefined;
    items: LoginAttemptShowIndexDto[] | undefined;

    constructor(data?: IPagedResultDtoOfLoginAttemptShowIndexDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                ...
                for (let item of data["items"])
                    this.items.push(LoginAttemptShowIndexDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfLoginAttemptShowIndexDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfLoginAttemptShowIndexDto();
        result.init(data);
        return result;
    }
    ...
    clone(): PagedResultDtoOfLoginAttemptShowIndexDto {
        const json = this.toJSON();
        let result = new PagedResultDtoOfLoginAttemptShowIndexDto();
        result.init(json);
        return result;
...
export interface IPagedResultDtoOfLoginAttemptShowIndexDto {
    totalCount: number | undefined;
    items: LoginAttemptShowIndexDto[] | undefined;
}
...
export class LoginAttemptShowIndexDto implements ILoginAttemptShowIndexDto {
    ...
    constructor(data?: ILoginAttemptShowIndexDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): LoginAttemptShowIndexDto {
        data = typeof data === 'object' ? data : {};
        let result = new LoginAttemptShowIndexDto();
        result.init(data);
        return result;
    }
    ...
    clone(): LoginAttemptShowIndexDto {
        const json = this.toJSON();
        let result = new LoginAttemptShowIndexDto();
        result.init(json);
        return result;
